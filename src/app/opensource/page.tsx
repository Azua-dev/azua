    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <p className="text-xl text-zinc-400 mb-8">
          At Azua.dev, we believe in the power of open source. Check out our projects and contribute to the future of
          developer collaboration.
        </p>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Card className="bg-zinc-900 border-zinc-800 p-6">
            <h2 className="text-2xl font-semibold mb-2">Azua.dev Core</h2>
            <p className="text-zinc-400 mb-4">The main repository for the Azua.dev platform.</p>
            ...
            <div className="flex space-x-2">
              <Button asChild variant="outline" size="sm" className="flex-1">
                <a href="https://github.com/Azua-dev" target="_blank" rel="noopener noreferrer">
          ...
          <Card className="bg-zinc-900 border-zinc-800 p-6">
            <h2 className="text-2xl font-semibold mb-2">Azua.dev UI</h2>
            <p className="text-zinc-400 mb-4">A collection of reusable UI components for Azua.dev</p>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                <Star className="w-4 h-4 mr-1 text-yellow-500" />
          ...
          <Card className="bg-zinc-900 border-zinc-800 p-6">
            <h2 className="text-2xl font-semibold mb-2">Azua.dev API</h2>
            <p className="text-zinc-400 mb-4">The official API for integrating with Azua.dev services.</p>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                <Star className="w-4 h-4 mr-1 text-yellow-500" />
